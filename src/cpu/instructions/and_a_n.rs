...
impl Instruction for AndAN {

    #[inline]
    fn from_opcode(opcode: &u8) -> Option<Box<dyn Instruction>> {
        if *opcode == 0xE6 {
            return Some(Box::new(AndAN {
                counter: 1,
                value: 1
            }))
        }
...
mod add_a_a {
    ...
    reusable_testing_macro!(0xE6, AndAN);
    ...
    fn load_value_on_tick_1() {
        ...
        let mut instruction = AndAN { counter: 1, value:0 };
    ...
    fn and_a_from_n_on_tick_0() {
        ...
        let mut instruction = AndAN { counter: 0, value: 0x12 };
