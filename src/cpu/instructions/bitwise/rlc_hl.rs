...
impl Instruction for RlcHl {
    #[inline]
    fn from_opcode(opcode: &u8) -> Option<Box<dyn Instruction>> {
        if *opcode == 0x06 {
            return Some(Box::new(RlcHl{ counter: 3, value_register: Register8::new(0) }))
        }
        None
    }
    ...
    fn act(&mut self, registers: &mut Registers, alu: &mut ALU, memory_controller: Arc<Mutex<MemoryController>>, _enable_interrupts: &mut bool, _is_halted: &mut bool) -> bool {
        if self.counter == 3 {
            ...
            alu.rlc(&mut self.value_register);
        }
...
#[cfg(test)]
mod tests {
    use crate::cpu::instructions::rlca::RlcA;
    use super::*;

    reusable_testing_macro!(0x06, RlcHl);
    ...
    fn tests_bit_when_set_on_tick_3() {
        ...
        let mut instruction = RlcHl { counter: 3, value_register: Register8::new(0) };
    ...
    fn roll_on_tick_2() {
        ...
        let mut instruction = RlcHl { counter: 2, value_register: Register8::new(0b00010001) };
        ...
        assert_eq!(0b00100010, instruction.value_register.get_value());
    }
    ...
    fn write_value_on_tick_1() {
        ...
        let mut instruction = RlcHl { counter: 1, value_register: Register8::new(0x12) };
    ...
    fn get_next_instruction_on_tick_0() {
        ...
        let mut instruction = RlcHl { counter: 0, value_register: Register8::new(0x12) };
