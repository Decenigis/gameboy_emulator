...
impl Instruction for SbcAN {

    #[inline]
    fn from_opcode(opcode: &u8) -> Option<Box<dyn Instruction>> {
        if *opcode == 0xDE {
            return Some(Box::new(SbcAN {
                counter: 1,
                value: 1
            }))
        }
...
mod add_a_a {
    ...
    reusable_testing_macro!(0xDE, SbcAN);
    ...
    fn load_n_on_tick_1() {
        ...
        let mut instruction = SbcAN { counter: 1, value:0 };
    ...
    fn sbc_a_from_n_on_tick_0() {
        ...
        let mut instruction = SbcAN { counter: 0, value: 0x12 };
