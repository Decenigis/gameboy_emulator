...
pub fn decode_instruction(opcode: &u8) -> Box<dyn Instruction> {
    ...
    return_if_is_instruction!(Ccf, opcode);     //0x3F
    ...
    return_if_is_instruction!(SubAHl, opcode);  //0x96
    return_if_is_instruction!(SubAA, opcode);   //0x97
    return_if_is_instruction!(SbcAHl, opcode);  //0x9E
    return_if_is_instruction!(SbcAA, opcode);   //0x9F
    return_if_is_instruction!(AdcAHl, opcode);  //0x8E
    return_if_is_instruction!(AdcAA, opcode);   //0x8E
    return_if_is_instruction!(AndAHl, opcode);  //0xA6
    return_if_is_instruction!(AndAA, opcode);   //0xA7
    return_if_is_instruction!(XorAHl, opcode);  //0xAE
    return_if_is_instruction!(XorA, opcode);    //0xAF
    return_if_is_instruction!(OrAHl, opcode);   //0xB6
    return_if_is_instruction!(OrA, opcode);     //0xB7
    return_if_is_instruction!(CpAHl, opcode);   //0xBE
    return_if_is_instruction!(CpAA, opcode);    //0xBF
    ...
    return_if_is_instruction!(AddSpN, opcode);  //0xE8
    return_if_is_instruction!(JpHl, opcode);    //0xE9
    return_if_is_instruction!(LdNNA, opcode);   //0xEA
    return_if_is_instruction!(XorAN, opcode);   //0xEE
    return_if_is_instruction!(LdhAN, opcode);   //0xF0
    return_if_is_instruction!(LdhAC, opcode);   //0xF2
    return_if_is_instruction!(Di, opcode);      //0xF3
    return_if_is_instruction!(OrAN, opcode);    //0xF6
