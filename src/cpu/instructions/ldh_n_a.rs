...
mod tests {
    ...
    fn from_opcode_returns_given_0xe0() {
        let instruction = LdhNA::from_opcode(&0xE0);
    ...
    fn from_opcode_returns_none_given_non_0xe0() {
        let instruction = LdhNA::from_opcode(&0x00);
    ...
    fn get_opcode_returns_0xe0() {
        let instruction = LdhNA { counter: 0, address: 0 };
    ...
    fn load_address_on_tick_2() {
        ...
        let mut instruction = LdhNA { counter: 2, address: 0 };
    ...
    fn load_data_into_a_on_tick_1() {
        ...
        let mut instruction = LdhNA { counter: 1, address: 0xFF40 };
    ...
    fn get_next_instruction_on_tick_0() {
        ...
        let mut instruction = LdhNA { counter: 0, address: 0x1234 };
