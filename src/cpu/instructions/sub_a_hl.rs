...
impl Instruction for SubAHl {

    #[inline]
    fn from_opcode(opcode: &u8) -> Option<Box<dyn Instruction>> {
        if *opcode == 0x96 {
            return Some(Box::new(SubAHl {
                counter: 1,
                value: 1
            }))
        }
...
mod add_a_a {
    ...
    reusable_testing_macro!(0x96, SubAHl);
    ...
    fn get_value_on_tick_1() {
        ...
        let mut instruction = SubAHl { counter: 1, value:0 };
    ...
    fn sub_a_from_n_on_tick_0() {
        ...
        let mut instruction = SubAHl { counter: 0, value: 0x12 };
