...
impl ALU {
    ...
    pub fn rrc(&self, a: &mut Register8) {
        ...
        a.set_value((value >> 1) | ((value & 0x01) << 7));
    ...
    pub fn sra(&self, a: &mut Register8) {
        let mut flags = self.flags.borrow_mut();
        flags.set_bit(Self::SUB_FLAG, false);
        flags.set_bit(Self::HALF_CARRY_FLAG, false);
        flags.set_bit(Self::CARRY_FLAG, a.get_bit(0));

        let old_bit_7 = a.get_value() & 0x80;

        let value = a.get_value();
        a.set_value(old_bit_7 | (value >> 1));

        flags.set_bit(Self::ZERO_FLAG, a.is_zero());
    }

    pub fn rlc(&self, a: &mut Register8) {
        let mut flags = self.flags.borrow_mut();
        flags.set_bit(Self::SUB_FLAG, false);
        flags.set_bit(Self::HALF_CARRY_FLAG, false);
    ...
    pub fn rl(&self, a: &mut Register8) {
        ...
        flags.set_bit(Self::SUB_FLAG, false);
        flags.set_bit(Self::HALF_CARRY_FLAG, false);
        let new_carry_val = a.get_bit(7);

        let value = a.get_value();
        a.set_value((value << 1) | if flags.get_bit(Self::CARRY_FLAG) { 0x01 } else { 0x00 });

        flags.set_bit(Self::CARRY_FLAG, new_carry_val);
        flags.set_bit(Self::ZERO_FLAG, a.is_zero());
    }

    pub fn sla(&self, a: &mut Register8) {
        let mut flags = self.flags.borrow_mut();
        flags.set_bit(Self::SUB_FLAG, false);
        flags.set_bit(Self::HALF_CARRY_FLAG, false);
        flags.set_bit(Self::CARRY_FLAG, a.get_bit(7));
...
mod tests {
    ...
    #[test]
    fn or_internal_resets_sub_flag() {
        let a = Rc::new(RefCell::new(Register8::new(0b11110000)));
        let b = Rc::new(RefCell::new(Register8::new(0b01010101)));
        let flags = Rc::new(RefCell::new(Register8::new(0xFF)));
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn or_internal_resets_half_carry_flag() {
        let a = Rc::new(RefCell::new(Register8::new(0b11110000)));
        let b = Rc::new(RefCell::new(Register8::new(0b01010101)));
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn or_internal_resets_carry_flag() {
        let a = Rc::new(RefCell::new(Register8::new(0b11110000)));
        let b = Rc::new(RefCell::new(Register8::new(0b01010101)));
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn or_internal_sets_zero_flag_correctly() {
    ...
    #[test]
    fn or_internal_resets_zero_flag_correctly() {
    ...
    fn ors_correctly() {
        ...
        assert_eq!(a.get_value(), 0b11110101);
    }
    ...
    #[test]
    fn sra_rolls_into_carry_flag_when_bit_0() {
        let mut a = Register8::new(0b10010001);
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        flags.borrow_mut().set_bit(ALU::CARRY_FLAG, false);
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn sra_rolls_into_carry_flag_when_not_bit_0() {
        let mut a = Register8::new(0b10010000);
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        flags.borrow_mut().set_bit(ALU::CARRY_FLAG, true);
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn rlc_sets_flags_correctly_for_zero_no_carry() {
        let mut a = Register8::new(0b00000000);
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        let alu = ALU::new(flags.clone());
    ...
    #[test]
    fn rlc_sets_flags_correctly_for_nonzero_carry() {
    ...
    #[test]
    fn sla_rolls_into_carry_flag_when_bit_7() {
        let mut a = Register8::new(0b10001000);
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        flags.borrow_mut().set_bit(ALU::CARRY_FLAG, false);
        let alu = ALU::new(flags.clone());
        ...
        assert_eq!(0b00010000, a.get_value());
        assert_eq!(true, flags.borrow().get_bit(ALU::CARRY_FLAG));
    }

    #[test]
    fn sla_rolls_into_carry_flag_when_not_bit_7() {
        let mut a = Register8::new(0b00001000);
        let flags = Rc::new(RefCell::new(Register8::new(0x00)));
        flags.borrow_mut().set_bit(ALU::CARRY_FLAG, false);
        let alu = ALU::new(flags.clone());
